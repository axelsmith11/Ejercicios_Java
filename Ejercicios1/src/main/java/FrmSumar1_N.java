 ...
 */
public class FrmSumar1_N extends javax.swing.JFrame {

    /**
     * Creates new form FrmSumar1_N
     */
    public FrmSumar1_N() {
        initComponents();
    }
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        int i=0,suma=0;
        txtA.setText("La suma del 0 al N son :\n");
        while(i<=n1){
            if(i%2==0){
                suma+=i;
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSumar1_N.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmSumar1_N().setVisible(true);
            }
        });
    }

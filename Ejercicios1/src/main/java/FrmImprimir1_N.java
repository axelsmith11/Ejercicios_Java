 ...
 */
public class FrmImprimir1_N extends javax.swing.JFrame {

    /**
     * Creates new form FrmImprimir1_N
     */
    public FrmImprimir1_N() {
        initComponents();
    }
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        int i=0;
        txtA.setText("Los numeros del 0 al N son :\n");
        while(i<=n1){
            if(i==n1){
                txtA.append(""+i);
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmImprimir1_N.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmImprimir1_N().setVisible(true);
            }
        });
    }
